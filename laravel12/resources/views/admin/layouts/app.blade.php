...
<html lang="en">
  ...
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{ asset('admin/compiled-assets/css/index_cdn.css') }}"
    ...
    <link
      rel="stylesheet"
      href="{{ asset('admin/compiled-assets/css/overlayscrollbars_cdn.min.css') }}"
      crossorigin="anonymous"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('admin/compiled-assets/css/bootstrap-icons_cdn.min.css') }}"
      crossorigin="anonymous"
    />
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <script src="{{ asset('admin/compiled-assets/js/adminlte.min.js') }}"></script>
